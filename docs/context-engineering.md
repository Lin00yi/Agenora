...
| 多查询 RAG 聚合上限 | `backend/src/agent/nodes/kb_search.py` |
| Provider 安全提示词、最终预算与 Trace | `backend/src/agent/nodes/prompts_budget.py`、`backend/src/agent/nodes/reason.py` |
| SSE、持久化与观测 Trace 回写 | `backend/src/app.py` |
