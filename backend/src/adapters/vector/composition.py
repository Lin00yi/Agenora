...
behind this boundary, while legacy ``src.storage.vector.get_store`` forwards
...
class VectorStoreProvider:
    ...
    def _build_qdrant(config: VectorStoreConfig) -> VectorStore:
        from src.storage.vector.store import QdrantStore
    ...
    def _build_milvus(config: VectorStoreConfig) -> VectorStore:
        from src.storage.vector.store import MilvusStore
