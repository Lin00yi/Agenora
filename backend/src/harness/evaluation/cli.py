...
Examples:
  python -m src.harness.evaluation.cli --dataset config/rag_eval_cases.jsonl --results out.jsonl
  python -m src.harness.evaluation.cli --dataset config/rag_eval_cases.jsonl --kb-id ... --write-results out.jsonl --min-recall-at-k .8
  python -m src.harness.evaluation.cli --gate config/rag_eval_roogoo_gate.json --api-base-url http://127.0.0.1:8000 --api-token ...
"""
