...
def estimate_tokens(text: str, *, model: str | None = None) -> int:
    ...
    Prefers tiktoken (see ``src.platform.llm.tokenizer``). Falls back to a CJK-aware
    heuristic when the tokenizer package is unavailable.
    """
    from src.platform.llm.tokenizer import count_tokens
...
def truncate_text_to_token_budget(
    ...
    *,
    ...
    from src.platform.llm.tokenizer import truncate_to_token_budget
...
def resolve_context_window(
    ...
    from src.platform.llm.catalog import resolve_model_catalog_entry
