  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-active:border-surface-border/80 data-active:bg-surface data-active:text-ink dark:data-active:border-surface-border dark:data-active:bg-surface dark:data-active:text-ink",
