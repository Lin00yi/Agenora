  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[state=active]:border-surface-border/80 data-[state=active]:bg-surface data-[state=active]:text-ink dark:data-[state=active]:border-surface-border dark:data-[state=active]:bg-surface dark:data-[state=active]:text-ink",
