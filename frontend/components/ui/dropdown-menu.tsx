...
function DropdownMenu({
  ...
  // modal=false avoids a full-screen pointer-events layer that can make
  // table-row triggers feel "dead" inside overflow scroll containers.
  return (
...
function DropdownMenuCheckboxItem({
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      data-inset={inset}
      className={cn(
        "relative flex min-h-[var(--control-h)] cursor-pointer items-center gap-2 rounded-md py-2 pr-8 pl-3 text-sm text-ink outline-hidden select-none focus:bg-brand/10 focus:text-ink focus:**:text-ink data-inset:pl-8 data-disabled:pointer-events-none data-disabled:cursor-not-allowed data-disabled:opacity-50 dark:focus:bg-brand/15 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      checked={checked}
      {...props}
